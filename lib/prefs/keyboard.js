...
export class KeyboardPage extends PreferencesPage {
  ...
  constructor({ kbdSettings }) {
    ...
    this.add_group({
      ...
      description: _("Change the modifier key for tiling windows via drag-and-drop. Select 'None' to always tile"),
      children: [
        new RadioRow({
    ...
    this.add_group({
      title: _("Shortcuts"),
      description: _('Change the tiling shortcuts. To clear a shortcut clear the input field. To apply a shortcut press enter. <a href="https://github.com/forge-ext/forge/wiki/Keyboard-Shortcuts">Syntax examples</a>'),
