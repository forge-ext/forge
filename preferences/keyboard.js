...
export const KeyboardPage = GObject.registerClass(
  class KeyboardPage extends PreferencesPage {
    constructor({ settings }) {
      ...
      const description = `${_(
        "Syntax"
      )}: &lt;Super&gt;h, &lt;Shift&gt;g, &lt;Shift&gt;&lt;Super&gt;h
${_("Legend")}: &lt;Super&gt; - ${_("Windows  key")}, &lt;Primary&gt; - ${_("Control key")}
${Msgs.prefs_keyboard_update_keys_instructions_text} <i>${
        Msgs.prefs_keyboard_update_keys_resets_label
      }</i> ${Msgs.prefs_keyboard_update_keys_resets_sub_1_label}`;
